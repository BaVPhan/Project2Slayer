...
james = Hero.create(name: "ObiJames Kenobi", weapon_strength: 65, img_url: "http://encyclopedia.nuttybible.com/wp-content/uploads/2011/09/jesus-sword.png") # hahah awesome
rihanna = Hero.create(name: "Goddess Rihanna", weapon_strength: 60, img_url: "https://belleonlinemagazine.files.wordpress.com/2012/05/screen-shot-2012-05-06-at-6-41-32-am1.png") # best hero/heroine!
...
rihanna.monsters.create!({name: "Clifford the Hellhound", habitat: "Washington DC", health: 190, img_url: "http://orig00.deviantart.net/4449/f/2013/134/a/6/clifford_the_big_red_dog_for_mugen_sprite_by_neopets2012-d659p34.png"}) # lol clifford hellhound
